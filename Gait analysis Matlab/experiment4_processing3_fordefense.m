% 9/22/22
% for testing how much better the SFCWT features helped the classification

%% use decision tree to classify impacts
clear all
close all
% load training data
load('C:\Users\katie\Dropbox (MIT)\Lab\Analysis\Experiment4\Praneeth 5\ProcessedData\both_weight1.mat')
X_train2 = [X_train(:,1:6),X_train(:,19:end)]; % added this!
tree2 = fitctree(X_train2,Y_train);
...
X_test2 = [est_width,est_peak_mag,est_energy];

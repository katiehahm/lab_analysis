...
legend('GMM mixture 1','GMM mixture 2','GMM mean 1','GMM mean 2')
title('Step time distribution derived GMM results')
ylabel('Occurances')
xlabel('Step time (s)')
set(gca, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 16)
...
legend('GMM mixture 1','GMM mixture 2','GMM mean 1','GMM mean 2')
title('Step time distribution original GMM results')
ylabel('Occurances')
xlabel('Step time (s)')
set(gca, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 16)

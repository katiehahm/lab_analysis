...
for t = 1:length(takes)
    close all
    clearvars -except t takes
    processedfilepath = ['C:\Users\Katie\Dropbox (MIT)\Lab\Analysis\Experiment4\Praneeth 5\ProcessedData\both_', char(takes(t)),'.mat'];
    % processedfilepath = 'C:\Users\katie\Dropbox (MIT)\Lab\Analysis\Experiment4\Uriel 2\ProcessedData\both_weight2.mat';

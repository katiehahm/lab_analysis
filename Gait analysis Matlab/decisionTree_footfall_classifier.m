...
%% just classify 1 or 2 (no overlapping = 3 like above section)
...
detected_seg_starts = [0]; % start times of segments
...
% next fix big steps in x by replacing or overlapping
o_idx = find(Y_predict == 1);
...
% calculate success rate at this point
labeling_success_rate(impacts, detected_starts, Y_predict, Fs_pcb, Fs_fsr,0.08)
